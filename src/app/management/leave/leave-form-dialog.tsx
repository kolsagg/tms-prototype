      ...
      <DialogContent className="sm:max-w-[500px] bg-white">
        <DialogHeader>
          <div className="flex items-center justify-between">
            <DialogTitle>{isEdit ? "İzin Kaydını Düzenle" : "Yeni Kayıt"}</DialogTitle>
            <Button
              variant="ghost"
              size="sm"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent className="bg-white">
                ...
                <SelectItem value="analik">Analık İzni</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent className="bg-white">
                <SelectItem value="ali-yildirim">Ali Yıldırım</SelectItem>
                <SelectItem value="alper-atak">Alper Atak</SelectItem>
                <SelectItem value="ata-cetinkol">Ata Çetinkol</SelectItem>
                <SelectItem value="elif-zehra-alp">Elif Zehra Alp</SelectItem>
                <SelectItem value="emre-kolunsag">Emre Kolunsağ</SelectItem>
                <SelectItem value="fatih-taspin">Fatih Taşpın</SelectItem>
                <SelectItem value="fatih-yasak">Fatih Yasak</SelectItem>
                <SelectItem value="ibrahim-demir">İbrahim Demir</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            <span className="text-sm font-medium">Başlangıç-Bitiş Tarihi</span>
